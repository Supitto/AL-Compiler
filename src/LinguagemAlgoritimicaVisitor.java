...
public interface LinguagemAlgoritimicaVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link LinguagemAlgoritimicaParser#mais_variaveis}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMais_variaveis(LinguagemAlgoritimicaParser.Mais_variaveisContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link LinguagemAlgoritimicaParser#atribuicao_ponteiro}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAtribuicao_ponteiro(LinguagemAlgoritimicaParser.Atribuicao_ponteiroContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link LinguagemAlgoritimicaParser#chamada_atribuicao}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitChamada_atribuicao(LinguagemAlgoritimicaParser.Chamada_atribuicaoContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link LinguagemAlgoritimicaParser#mais_selecao}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMais_selecao(LinguagemAlgoritimicaParser.Mais_selecaoContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link LinguagemAlgoritimicaParser#op_multiplicaco}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOp_multiplicaco(LinguagemAlgoritimicaParser.Op_multiplicacoContext ctx);
	/**
