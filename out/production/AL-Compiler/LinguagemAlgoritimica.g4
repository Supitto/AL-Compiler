...
para : PARA ID '<-' exp_aritimetica ATE exp_aritimetica FACA cmd* FIM_PARA;
enquanto : ENQUANTO expressao FACA cmd* FIM_ENQUANTO;
faca : FACA cmd* ATE expressao;
...
selecao : constantes DOIS_PONTOS comandos;
